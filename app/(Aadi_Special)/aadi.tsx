      ...
      <div>
        <div className='overflow-hidden'>
          <div className='relative'>
            <Image className='absolute bg-tranparent top-40 transition ease-in duration-200 max-xl:right-[-1050px] tranpa xl:right-[-970px] -z-30 image' width='227' height='400' src="/mars-removebg-preview.png" alt="space-img" />
          </div>
