...
const CopilotFeature = (props: Props) => {
  ...
  return (
    ...
    <div className='md:flex flex-col md:space-y-20 flex-1 p-8 sm:p-10 lg:py-16 lg:pl-16 lg:pr-32 justify-between '>
        <p className=" text-xl md:text-2xl mb-6 font-medium text-[#7d8590]"><span className='text-white font-medium'>Athlete Backer</span> focus solely on raising funds, we go a step further. We curate campaigns that have the potential to create real, meaningful impact. Our commitment is to projects that bring about positive change, whether its in technology, arts, social good, or beyond.</p>
        <div>
