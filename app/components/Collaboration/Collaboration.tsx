      ...
      <div className='flex md:pl-7 space-x-3 md:space-x-10'>
        ...
        <HoverCard backgroundColor='#ffa28b' direction='' left=''>
          <div className='md:flex flex-col md:space-y-20 flex-1 py-20 p-10  justify-between'>
              <p className=" text-xl md:text-2xl mb-6 font-medium text-[#7d8590]"><span className='text-white font-medium'>Athlete Backer</span>  lets you support campaigns that have the potential to create real and meaningful impact on the society.</p>
              <div>
