    ...
    <div className='max-w-[1280px] mx-auto relative z-[2]'>
      <div className='flex my-8 md:my-16 sm:my-12 relative md:items-center text-center flex-col'>
          <div className='py-3 mb-2 flex flex-col justify-center items-center'>
            ...
            <p className="mb-4 md:text-xl text-[16px] text-[#7d8590] px-4 mx-auto md:w-7/12">Whether you’re scaling your startup or want to fund your ideas, Athlete Backer is your home. Join the platform to help build the innovations that empower humanity. Let’s&nbsp;build from&nbsp;here.</p>
