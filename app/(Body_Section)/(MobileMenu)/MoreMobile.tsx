...
function MoreMobile() {
  ...
  return (
    ...
    >
      ...
      >
        <div className=" flex flex-col">
          <span className=" font-bold text-gray-200 text-[16px] ">Campaings</span>
          <p className=" mt-[5px] text-[14px] text-gray-300 ">
            Create New Campaings and register for funds...
          </p>
        </div>
      </a>
      <div className="w-full h-auto hover:bg-[#221d41] rounded-[8px] flex flex-row py-[13px] px-[5px] ">
        <div className=" flex flex-col">
          ...
          <p className=" mt-[5px] text-[14px] text-gray-300 ">
            Join the Discord community to ask questions, share your POV,
            and help others.
          </p>
        </div>
      </div>
